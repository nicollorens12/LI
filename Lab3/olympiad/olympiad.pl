...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% For the next Catalan Computer Science Olympiad, we want to make the
%% best possible team by selecting a set of students. For each student,
%% we have the following information:
%%
%% 1.- Her ID
%% 2.- The list of other students which she considers friends. Note that
%%     S1 could consider S2 as a friend, but the converse is not
%%     necessarily true.
%% 3.- The programming topic she is most expert on.
%%
%% The goal is to form a team with exactly K students such that each
%% one of them considers all other team members a friend and all
%% chosen students haver different expertise topics.
%%
...
allFriendBetween:-
        ...
        S1 \= S2,
        \+friends(S1,S2),
        writeOneClause([-chosen(S1),-chosen(S2)]), %% if S1 and S2 are not friend S1 -> -S2 (-S1 v -S2)
        fail.
allFriendBetween.
