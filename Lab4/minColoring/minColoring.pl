...
writeClauses(infinite):- !, numNodes(N), writeClauses(N),!. %Itera provando desde los N colores hasta 0
...
%%%%%%% Sort nos sirve para eliminar colores repetidos en la lista L
