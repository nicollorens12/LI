...
main:-
    ...
    all_distinct(Vars),
    findall([N1, N2, N3, N4], (word([A, B, C, D]), num(A, N1), num(B, N2), num(C, N3), num(D, N4)), Words), %Lista de palabras a lista de lista de palabras como numeros
    findall([W1,W2],(member(Word, Words), member(W1, Word), member(W2, Word), W1 < W2), Temp),
