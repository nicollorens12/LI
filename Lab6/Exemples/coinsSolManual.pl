...
%2: Constraints:
    ...
    %% Aquí fixem a "má" un limit superior del numero de monedes, i anem baixant fins a trobar una solució.
    %% Des de 7 fins a 4 que és el minim que busquem. Es pot comprovar que amb 1, 2 o 3 monedes no hi ha solució
    ExprSum #=< 7,
