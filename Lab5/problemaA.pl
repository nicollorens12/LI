...
condicions(D):-
    ...
    member([1,_,_,_,_,_,hungria],D),
    member([_,verd,_,_,_,conac,_],D),
    between(1,4,I),
    J is I+1,
    member([I,verd,_,_,_,_,_],D),
    member([J,blanca,_,_,_,_,_],D),
    member([_,_,escultor,cargols,_,_],D),
    member([_,groc,actor,_,_,_],D),
    member([3,_,_,_,_,cava,_],D),
    %11
    ...
    member([VeiHungares,_,_,_,_,hungria],D),
    %13
